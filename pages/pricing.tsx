                                        ...
                                        <>
                                            ...
                                            {sections.map((section) => (
                                                <li key={section.name}>
                                                    <ul role="list" className="space-y-4">
                                                        {section.features.map((feature) =>
                                                            feature.tiers[tier.name] && !feature.tiers['Free'] ? (
                                                                <li key={feature.name} className="flex gap-x-3">
                                                                    {feature.status === "IN_PROGRESS" ? (
                                                                        <div className="text-center">🚧</div>
                                                                    ) : (
                                                                ...
                                                                <>
                                                                    {feature.status === "IN_PROGRESS" ? (
                                                                        ...
                                                                        feature.tiers[tier.name] === true ? (
                                                                            ...
                                                                            <XIcon className="mx-auto h-5 w-5 text-gray-400 dark:text-white" aria-hidden="true" />
                                                                        )
                                                                    )}
...
const sections = [
    {
        ...
        features: [
            ...
            { name: 'Obsidian plugin', tiers: { Free: true, Pro: true }, status: "IN_PROGRESS" },
    ...
    },
    {
        ...
        features: [
            ...
            { name: 'Removed Flowershow branding', tiers: { Pro: true } },
        ],
    },
    {
        name: 'Content',
