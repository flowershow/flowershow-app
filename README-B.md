---
title: Publish Your Markdown as a Website — Instantly
description: Turn any Markdown folder into a beautiful, shareable website in seconds. Perfect for blogs, docs, and digital gardens — no setup or coding needed.
layout: plain
showToc: false
showEditLink: false
showComments: false
...
<div className="py-12 sm:py-24">
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-3xl text-center">
      <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl">Publish Your Markdown as a Website — Instantly</h1>
      <p className="mt-8 text-pretty text-lg text-gray-500 sm:text-xl/8">Turn any Markdown folder into a beautiful, shareable website in seconds. Perfect for blogs, docs, and digital gardens — no setup or coding needed.<sup title="Yes, we know you could code your own site in NextJS, Hugo or whatever. (We did that too). But is that *really* the best use of your time? (OK, OK, if you deploy your apps to baremetal and roll your own Linux, then go for it!) But otherwise give us a try.">*</sup></p>
